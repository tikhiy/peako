...
( function ( jqAccess ) {
  ...
  prototype.removeAttr = function ( names ) {
    var i = this.length - 1,
        lastIndex = ( names = toWords( names ) ).length - 1,
        el, j;
  ...
  prototype.attr = function ( name, val ) {
    return jqAccess( this, attr, name, val, val !== undefined, null );
  };

  prototype.prop = function ( name, val ) {
    return jqAccess( this, prop, name, val, val !== undefined, null );
  };
} )( jqAccess );
